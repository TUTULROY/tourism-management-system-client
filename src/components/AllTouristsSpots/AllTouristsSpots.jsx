...
const AllTouristsSpots = ({all_spot}) => {
    const {_id, tourists_spot_name, seasonality, travel_time, totalVisitorsPerYear,country_Name, average_cost, photo}=all_spot;
        ...
        <div className=" bg-base-100 shadow-xl">
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title">
              Tourists Spot Name: {tourists_spot_name}
            </h2>
            <h2 className="text-xl">Country: {country_Name}</h2>
